    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                  ...
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.baoxiuzhuangtai" placeholder="报修状态" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.baoxiuzhuangtai" placeholder="报修状态" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.baoxiuzhuangtai" placeholder="报修状态" clearable></el-input>
                </el-form-item>
                                                                                                                                                            <el-form-item>
      ...
      this.contents.pageEachNum = 10
            ...
            if (data && data.code === 0) {
              ...
              this.$message.error(data.msg);
                                                                                ...
                                                                                this.baoxiuzhuangtaiOptions = "正常,故障".split(',')
                                                                                                                                                                                                                                      },
    search() {
      this.pageIndex = 1;
      this.getDataList();
