  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qiandingshijian" label="签订时间" prop="qiandingshijian">
              <el-input v-model="ruleForm.qiandingshijian" 
                placeholder="签订时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                                              ...
                                                                                              this.$http({
              url: `option/fangwuxinxi/fangwubianhao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                            ...
                                                                            this.zufangzhuangtaiOptions = "已退租,在租中".split(',')
                                                                                  },
                    // 下二随
    zhanghaoChange () {
      this.$http({
        url: `follow/zuke/zhanghao?columnValue=`+ this.ruleForm.zhanghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                ...
                this.ruleForm.shouji = data.data.shouji
                                                                      ...
                                                                      if(data.data.xiangxidizhi){
                this.ruleForm.xiangxidizhi = data.data.xiangxidizhi
              }
                                                if(data.data.zujia){
    ...
    fangwubianhaoChange () {
      this.$http({
        url: `follow/fangwuxinxi/fangwubianhao?columnValue=`+ this.ruleForm.fangwubianhao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                if(data.data.xingming){
