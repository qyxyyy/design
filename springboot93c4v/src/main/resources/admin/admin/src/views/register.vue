  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.22);borderRadius:10px">
        <h1 class="h1" style="color:rgba(104, 223, 240, 1);fontSize:28px;">房屋租赁系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='zuke'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='zuke'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='zuke'">
