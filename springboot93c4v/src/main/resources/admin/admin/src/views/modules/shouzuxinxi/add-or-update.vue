<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="收租编号" prop="shouzubianhao">
            <el-input v-model="ruleForm.shouzubianhao" 
                placeholder="收租编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shouzubianhao" label="收租编号" prop="shouzubianhao">
              <el-input v-model="ruleForm.shouzubianhao" 
                placeholder="收租编号" readonly></el-input>
          </el-form-item>
        </div>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="房屋编号" prop="fangwubianhao">
          <el-select  @change="fangwubianhaoChange" v-model="ruleForm.fangwubianhao" placeholder="请选择房屋编号">
            <el-option
                v-for="(item,index) in fangwubianhaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
          ...
          <el-form-item class="input" label="租价" prop="zujia">
              <el-input v-model="ruleForm.zujia" 
                placeholder="租价" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="租房状态" prop="zufangzhuangtai">
          <el-select v-model="ruleForm.zufangzhuangtai" placeholder="请选择租房状态">
            <el-option
                v-for="(item,index) in zufangzhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="租房状态" prop="zufangzhuangtai">
	      <el-input v-model="ruleForm.zufangzhuangtai"
                placeholder="租房状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  data() {
	...
	zujia : false,
	zufangzhuangtai : false,
	dengjiriqi : false,
	beizhu : false,
      },
            ruleForm: {
                        shouzubianhao: this.getUUID(),
                        	        fangwubianhao: '',
	                        	        zhanghao: '',
	                        	        xingming: '',
	                        	        shenfenzheng: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='shouzubianhao'){
            this.ruleForm.shouzubianhao = obj[o];
	    this.ro.shouzubianhao = true;
            continue;
          }
	            	            if(o=='fangwubianhao'){
	    ...
	    this.ro.zujia = true;
            continue;
	            	            ...
	            	            if(o=='zufangzhuangtai'){
            this.ruleForm.zufangzhuangtai = obj[o];
	    this.ro.zufangzhuangtai = true;
            continue;
          }
	            	            if(o=='dengjiriqi'){
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                                                                                                                                        ...
                                                                                                                                                                                        this.zufangzhuangtaiOptions = "已交,未交".split(',')
                                                                },
                    // 下二随
    fangwubianhaoChange () {
      this.$http({
        url: `follow/zulinhetong/fangwubianhao?columnValue=`+ this.ruleForm.fangwubianhao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                ...
                this.ruleForm.shouji = data.data.shouji
                                                                                                                  ...
                                                                                                                  if(data.data.zujia){
                this.ruleForm.zujia = data.data.zujia
              }
                                                                                                } else {
          this.$message.error(data.msg);
        }
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../springboot93c4v/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shouzuxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shouzuxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
