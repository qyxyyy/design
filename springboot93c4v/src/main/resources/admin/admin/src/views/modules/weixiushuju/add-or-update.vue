    ...
    >
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="维修物品" prop="weixiuwupin">
          <el-input v-model="ruleForm.weixiuwupin" 
              placeholder="维修物品" clearable  :readonly="ro.weixiuwupin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="维修物品" prop="weixiuwupin">
              <el-input v-model="ruleForm.weixiuwupin" 
                placeholder="维修物品" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="维修次数" prop="weixiucishu">
          <el-input v-model="ruleForm.weixiucishu" 
              placeholder="维修次数" clearable  :readonly="ro.weixiucishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="维修次数" prop="weixiucishu">
              <el-input v-model="ruleForm.weixiucishu" 
                placeholder="维修次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="月份" prop="yuefen">
              <el-input v-model="ruleForm.yuefen" 
                placeholder="月份" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="维修人员" prop="weixiurenyuan">
          <el-input v-model="ruleForm.weixiurenyuan" 
              placeholder="维修人员" clearable  :readonly="ro.weixiurenyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="维修人员" prop="weixiurenyuan">
              <el-input v-model="ruleForm.weixiurenyuan" 
                placeholder="维修人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.weixiuwupin = true;
            continue;
	            	            ...
	            	            if(o=='weixiucishu'){
            this.ruleForm.weixiucishu = obj[o];
	    this.ro.weixiucishu = true;
            continue;
          }
	            	            if(o=='yuefen'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `weixiushuju/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.weixiushujuCrossAddOrUpdateFlag = false;
                  this.parent.search();
