          ...
          <el-form-item class="input" label="身份证" prop="shenfenzheng">
              <el-input v-model="ruleForm.shenfenzheng" 
                placeholder="身份证" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="看房时间" prop="kanfangshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.kanfangshijian" 
                type="date"
                placeholder="看房时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kanfangshijian" label="看房时间" prop="kanfangshijian">
              <el-input v-model="ruleForm.kanfangshijian" 
                placeholder="看房时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shenfenzheng = true;
            continue;
	            	            ...
	            	            if(o=='kanfangshijian'){
            this.ruleForm.kanfangshijian = obj[o];
	    this.ro.kanfangshijian = true;
            continue;
          }
	            	            if(o=='shenqingriqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `kanfangshenqing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kanfangshenqingCrossAddOrUpdateFlag = false;
                  this.parent.search();
