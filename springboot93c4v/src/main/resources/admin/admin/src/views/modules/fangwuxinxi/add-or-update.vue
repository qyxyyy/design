  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="租价" prop="zujia">
              <el-input v-model="ruleForm.zujia" 
                placeholder="租价" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="户主姓名" prop="huzhuxingming">
          <el-select  @change="huzhuxingmingChange" v-model="ruleForm.huzhuxingming" placeholder="请选择户主姓名">
            <el-option
                v-for="(item,index) in huzhuxingmingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.huzhuxingming" label="户主姓名" prop="huzhuxingming">
              <el-input v-model="ruleForm.huzhuxingming" 
                placeholder="户主姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.fabushijian" label="发布时间" prop="fabushijian">
              <el-input v-model="ruleForm.fabushijian" 
                placeholder="发布时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所在省份" prop="suozaishengfen">
          <el-input v-model="ruleForm.suozaishengfen" 
              placeholder="所在省份" clearable  :readonly="ro.suozaishengfen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所在省份" prop="suozaishengfen">
              <el-input v-model="ruleForm.suozaishengfen" 
                placeholder="所在省份" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fabushijian = true;
            continue;
	            	            ...
	            	            if(o=='suozaishengfen'){
            this.ruleForm.suozaishengfen = obj[o];
	    this.ro.suozaishengfen = true;
            continue;
          }
	            	            if(o=='suozaichengshi'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                            ...
                                                                            this.$http({
              url: `option/huzhu/huzhuxingming`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.huzhuxingmingOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    huzhuxingmingChange () {
      this.$http({
        url: `follow/huzhu/huzhuxingming?columnValue=`+ this.ruleForm.huzhuxingming,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../springboot93c4v/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
