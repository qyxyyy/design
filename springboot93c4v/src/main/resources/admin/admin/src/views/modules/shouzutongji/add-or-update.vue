<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收租统计" prop="shouzutongji">
          <el-input v-model="ruleForm.shouzutongji" 
              placeholder="收租统计" clearable  :readonly="ro.shouzutongji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收租统计" prop="shouzutongji">
              <el-input v-model="ruleForm.shouzutongji" 
                placeholder="收租统计" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收租人数" prop="shouzurenshu">
          <el-input v-model="ruleForm.shouzurenshu" 
              placeholder="收租人数" clearable  :readonly="ro.shouzurenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收租人数" prop="shouzurenshu">
              <el-input v-model="ruleForm.shouzurenshu" 
                placeholder="收租人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收租金额" prop="shouzujine">
          <el-input v-model="ruleForm.shouzujine" 
              placeholder="收租金额" clearable  :readonly="ro.shouzujine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收租金额" prop="shouzujine">
              <el-input v-model="ruleForm.shouzujine" 
                placeholder="收租金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='shouzutongji'){
            this.ruleForm.shouzutongji = obj[o];
	    this.ro.shouzutongji = true;
            continue;
          }
	            	            if(o=='shouzurenshu'){
            this.ruleForm.shouzurenshu = obj[o];
	    this.ro.shouzurenshu = true;
            continue;
          }
	            	            if(o=='shouzujine'){
            this.ruleForm.shouzujine = obj[o];
	    this.ro.shouzujine = true;
            continue;
          }
	            	            if(o=='dengjishijian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shouzutongji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shouzutongjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
